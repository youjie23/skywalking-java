 ...
 */
public class MdcPutInterceptor implements StaticMethodsAroundInterceptor {
    ...
    public Object afterMethod(Class clazz, Method method, Object[] allArguments, Class<?>[] parameterTypes,
        ...
        if (StringUtil.isNotBlank(swTraceId)) {
            return ret;
        }
        ...
        if (StringUtil.isBlank(swTraceId)) {
            swTraceId = ContextManager.getGlobalTraceId();
        }
        MDC.put(TID, swTraceId);
        return ret;
    }
